...
const questions: string[] = JSON.parse(fs.readFileSync("question.json", "utf-8"));
let userData: Record<string, string> = loadData();
let runningUsers: Record<string, UserStats> = {};
...
async function sendChatRequest(apiKey: string, question: string): Promise<string | null> {
    try {
...
function startNode(userId: string, ctx: Context) {
